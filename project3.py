...
def showimage():
    global filename
    global img
    filename=filedialog.askopenfilename(initialdir="C:\\Users\\hp\\Desktop\\image",
...
def Save():
    ...
    if N1=="" or C1=="Select Class" or D2=="" or Re1=="" or S1=="" or fathername=="" or mothername=="" or F1=="" or M1=="":
        ...
        try:
            img.save("C:\\Users\\hp\\Desktop\\image"+str(R1)+".jpg")
        except:
...
##    print(x12)
    ...
    img = (Image.open("C:\\Users\\hp\\Desktop\\image"+str(x1)+".jpg"))
    resized_image=img.resize((190,190))
    photo2 = ImageTk.PhotoImage(resized_image)
    lbl.config(image=photo2)
    lbl.image=photo2
...
def  Update():
    ...
    #sheet.cell(column=1,row=int(reg_number),value=R1) now none can update registration no.
...
#top Frames
Label(root,text="Email:saqibvns2000@gmail.com",width=10,height=3,bg="#f0687c",anchor='e').pack(side=TOP,fill=X)
Label(root,text="STUDENT REGISTRATION",width=10,height=2,bg="#c36464",fg='#fff', font='arial 20 bold').pack(side=TOP,fill=X)

#search box to update
Search=StringVar()
Entry(root,textvariable=Search,width=15,bd=2,font="arial 20").place(x=820,y=70)
imageicon3=PhotoImage(file="C:\\Users\hp\\Downloads\\search.png")
Srch=Button(root,text="Search",compound=LEFT,image=imageicon3,width=123,bg='#68ddfa',font="arial 13 bold",command=search)
Srch.place(x=1060,y=66)

imageicon4=PhotoImage(file="C:\\Users\hp\\Downloads\\Layer 4.png")
...
img=PhotoImage(file="C:\\Users\hp\\Downloads\\upload photo.png")
